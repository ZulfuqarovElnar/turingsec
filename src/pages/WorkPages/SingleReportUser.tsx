                                ...
                                <div className="rounded-xl overflow-hiddenp-8 flex max-h-[380px] justify-center">
                                    <div className="flex flex-col w-full p-5 overflow-y-scroll bluescroll ">
                                        ...
                                        {[...messages, ...newMessages].map((msg, i) => {
                                            ...
                                            return (
                                                <div key={i} className={`flex flex-col ${msg.isHacker ? 'justify-end' : 'justify-start'} gap-5 px-3 w-full`}>
                                                    <div className={`flex items-start gap-3 w-full ${msg.isHacker ? 'flex-row-reverse' : 'flex-row'}`}>
                                                        {/* Message Header */}
                                                        <div className={`flex justify-between items-center w-full ${msg.isHacker ? 'flex-row-reverse' : ''}`}>
                                                            ...
                                                            {(i === 0 || (messages[i - 1] && messages[i - 1].isHacker !== msg.isHacker)) && (
                                                                <div className={`flex items-center gap-4 mt-4 ${msg.isHacker ? 'flex-row-reverse' : ''}`}>
                                                                    ...
                                                                    <span className="text-white font-bold text-lg">{msg.isHacker ? 'Hacker' : 'Guest'}</span>
                                                                </div>
                                                            )}

                                                            {/* Timestamp */}
                                                            {(i === 0 || (messages[i - 1] && messages[i - 1].isHacker !== msg.isHacker)) && (
                                                                <span className={`text-[#A5A5A5] text-2xl font-semibold mt-4 ${msg.isHacker ? 'text-right' : 'text-left'}`}>
                                                    ...
                                                    {/* Message Body */}
                                                    <div className={`flex ${msg.isHacker ? 'justify-end' : 'justify-start'}`}>
