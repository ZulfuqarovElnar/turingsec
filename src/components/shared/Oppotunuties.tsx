  ...
  return (
    <section className=" pb-4 ">
      ...
      <div className="flex w-full p-8 bg-[#583555] rounded-md bg-clip-padding backdrop-filter backdrop-blur-2xl bg-opacity-45 justify-around text-white gap-8 flex-col lg:flex-row ">
        <div className="pt-20 bg-[url(/assets/images/hacker.jpg)] bg-cover bg-center rounded-2xl p-8 hover:cursor-pointer hover:scale-105 transition-all duration-300 xl:w-1/3 w-full">
        ...
        <div className="pt-20 bg-[url(/assets/images/company.jpg)]  bg-cover bg-center  rounded-2xl p-8 filter hover:cursor-pointer hover:scale-105 transition-all duration-300 xl:w-1/3 w-full relative h-auto">
